"""
Django settings for titlecompany project.
...
ROOT_URLCONF = 'titlecompany.urls'

WSGI_APPLICATION = 'titlecompany.wsgi.application'
...
DEFAULT_FILE_STORAGE = 'titlecompany.s3utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'titlecompany.s3utils.StaticRootS3BotoStorage'
...
COMPRESS_URL = 'http://titlecompanybucket.s3.amazonaws.com/'
